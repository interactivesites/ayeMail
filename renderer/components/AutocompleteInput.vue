  ...
  <div class="relative" ref="containerRef">
    ...
    >
      <div class="max-h-60 overflow-y-auto">
        ...
        >
          <div class="text-sm text-gray-900" v-html="highlightMatch(getItemLabel(item), searchQuery)"></div>
          <div v-if="getItemValue(item) !== getItemLabel(item)" class="text-xs text-gray-500 mt-0.5">
            {{ getItemValue(item) }}
          </div>
        </button>
      </div>
