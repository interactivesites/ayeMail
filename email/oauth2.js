...
exports.initiateOAuth2Flow = initiateOAuth2Flow;
exports.refreshOAuth2Token = refreshOAuth2Token;
const electron_1 = require("electron");
const crypto_1 = require("crypto");
const OAUTH2_CONFIGS = {
    gmail: {
...
async function initiateOAuth2Flow(provider) {
...
async function refreshOAuth2Token(provider, refreshToken) {
    const config = OAUTH2_CONFIGS[provider];
    if (!config) {
        throw new Error(`Unsupported OAuth2 provider: ${provider}`);
    }
